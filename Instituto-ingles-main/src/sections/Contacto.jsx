...
import mapaDireccion from "../assets/mapaDireccion.webp";
  ...
  return (
    ...
    >
      ...
      <div className="contacto-informacion">
        ...
        <InformacionContacto
          svg={iconoTelefono}
          informacion="2494 675012 "
        ></InformacionContacto>
        <InformacionContacto
          svg={iconoWhatsapp}
          informacion="Whatsapp: 2494 675012"
          direccion="https://wa.me/542494630209"
        ></InformacionContacto>
        <InformacionContacto
          svg={iconoInstagram}
      ...
      <div className="contacto-mapa">
        ...
        >
          ...
          />
          <Marker position={[-37.320987, -59.1316403]} icon={customIcon}>
            <Popup>
              <strong>Instituto de Inglés Marisa</strong>
              <br />
              Yrigoyen 1332, Tandil, Buenos Aires
            </Popup>
          </Marker>
        </MapContainer>
      </div>
